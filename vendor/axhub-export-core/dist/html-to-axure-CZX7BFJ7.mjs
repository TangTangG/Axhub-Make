...
var GENERIC_FONT_FAMILY_FALLBACKS = {
...
var SAFE_LOCAL_FONT_FAMILY_FALLBACKS = [
  "Arial",
  "Helvetica Neue",
  "Helvetica",
  "Segoe UI",
...
var splitCssFontFamilyCandidates = (fontFamily) => {
  const result = [];
  const regex = /(?:"([^"]+)"|'([^']+)'|([^,\s][^,]*))/g;
  let match = null;
...
var normalizeFontStretch = (fontStretch) => {
...
var checkFontAvailable = /* @__PURE__ */ (() => {
  let ctx = null;
...
var resolveAvailableFontFamily = (fontFamily, computedStyle) => {
...
var __resolveAvailableFontFamilyForTests = resolveAvailableFontFamily;
...
export {
  __resolveAvailableFontFamilyForTests,
