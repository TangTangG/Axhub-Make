...
export interface ReactTweakPanelProps {
  ...
  disabled?: boolean;
  onChange?: (patch: CommentaryTweakValues) => void | Promise<void>;
}
...
type AttributeTreeProps = {
  attributes: CommentaryTweakValues;
  config: ConfigNode;
  onChange: (patch: CommentaryTweakValues) => void | Promise<void>;
};
...
function readValue(
  attributes: CommentaryTweakValues,
  config: ConfigNode,
): CommentaryTweakValue | undefined {
  if (!config.attributeId) {
    return config.initialValue as CommentaryTweakValue | undefined;
  }

  const value = attributes[config.attributeId];
  return value === undefined ? (config.initialValue as CommentaryTweakValue | undefined) : value;
}

function asStringValue(value: CommentaryTweakValue | undefined): string {
...
function asNumberValue(value: CommentaryTweakValue | undefined): number | null {
  return typeof value === 'number' && Number.isFinite(value) ? value : null;
}

function asBooleanValue(value: CommentaryTweakValue | undefined): boolean {
  return value === true;
}
