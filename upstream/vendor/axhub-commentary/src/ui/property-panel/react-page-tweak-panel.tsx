...
import type { CommentaryTweakEntry, CommentaryTweakValues } from '../../tweak/protocol';
...
export interface ReactPageTweakPanelProps {
  entries: readonly CommentaryTweakEntry[];
  disabled?: boolean;
  onChange?: (element: Element, patch: CommentaryTweakValues) => void | Promise<void>;
